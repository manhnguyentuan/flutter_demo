...
import 'package:flutter_review_movie/mobie/ui/common/collapsing_toolbar.dart';
import 'package:flutter_review_movie/mobie/ui/common/my_text_styles.dart';
import 'package:flutter_review_movie/mobie/ui/common/trailers.dart';
      ...
      body: NestedScrollView(
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return <Widget>[
            CollapsingToolbar(
                title: '${movie.title}',
                backdrop: '${Config.BACKDROP_PATH_URL}${movie.backdropPath}'),
          ];
        },
        body: ListView(
